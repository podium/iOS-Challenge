...
struct SwiftScript: ParsableCommand {
  ...
  struct DownloadSchema: ParsableCommand {
    ...
    func run() throws {
      ...
      let endpoint = URL(string: "https://podium-fe-challenge-2021.netlify.app/.netlify/functions/graphql")!
      ...
      let appName = "Movie Challenge"

      let folderForDownloadedSchemaUIKit = fileStructure.sourceRootURL
        .apollo.childFolderURL(folderName: "UIKit")
  ...
  struct GenerateCode: ParsableCommand {
    ...
    func run() throws {
      ...
      let targetRootURLUIKit = fileStructure.sourceRootURL
        .apollo.childFolderURL(folderName: "UIKit")
        .apollo.childFolderURL(folderName: appName)
        .apollo.childFolderURL(folderName: appName)
